...
class RekomendasiPenjahitAdapter :
    RecyclerView.Adapter<RekomendasiPenjahitAdapter.RekomendasiPenjahitViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val itemRowPenjahitBinding =
            ItemRowPenjahitBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class RekomendasiPenjahitViewHolder(private var binding: ItemRowPenjahitBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(data: Nilai) {
            binding.apply {
                tvNamaPenjahit.text = data.nama_penjahit
                tvNamaToko.text = getHasilOlahDataLongLat(dataPelanggan, data) + " meter"
